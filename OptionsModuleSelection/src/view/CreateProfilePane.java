...
public class CreateProfilePane extends GridPane implements Serializable {

	
	/**
	 * 
	 */
	private static final long serialVersionUID = 9193278124820396579L;
	...
	public Course getSelectedCourseNo() {
		return cboCourse.getSelectionModel().getSelectedItem();
	}
